		...
		for joint, joint_nr in zip(leg.joints, range(len(leg.joints))):
			if joint.fatalError:
				...
				for error_name in self.error_names:
					...
					joint.UpdateValue(error_name)
					print(joint.GetValue(error_name))
				...
				print('outputPosition:',joint.outputPosition)
				print('inputPosition:',joint.inputPosition)
				print('torsion:',joint.torsion)
				print('torsionLimits:',joint.torsionLimits)

				#print('torsionOffset:',joint.torsionOffset)
				#print('outputPositionOffset:',joint.outputPositionOffset)

				print('torsionMeasured:',joint.torsionMeasured)
				print('outputPositionMeasured:',joint.outputPositionMeasured)
